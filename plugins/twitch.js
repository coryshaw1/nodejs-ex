    ...
    request('http://api.betterttv.net/2/emotes', function(error, response, body) {
        if (!error && response.statusCode == 200) {
            ...
            data.emotes.forEach(function(el, i, arr) {
                ...
                if(el.imageType === "gif")
                    module.exports.gifCommands.push(_key);
...
module.exports.addTwitchChannel = function(channelName, commands, commandCallback, messageCallback, successCallback) {
    ...
    if(module.exports.channels.indexOf(channelName.toLowerCase()) > -1)
        return messageCallback('Channel already added! Run this command to find out their emotes: !twitch ' + channelName);
